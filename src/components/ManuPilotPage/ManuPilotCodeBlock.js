  ...
  return (
    <div className="relative w-full max-w-full sm:max-w-[570px] min-[700px]:max-w-[625px] min-[750px]:max-w-[675px] min-[850px]:max-w-[750px] my-4 rounded-md border border-accent-border bg-bg-secondary ">
      ...
      <SyntaxHighlighter
        ...
        className="w-full max-w-full sm:max-w-[570px] min-[700px]:max-w-[625px] min-[750px]:max-w-[675px] min-[825px]:max-w-[750px] overflow-x-auto thin-scrollbar "
      >
        {code}
      </SyntaxHighlighter>
    </div>
...
export default ManuPilotCodeBlock;
