...
const DiscussionSideBar = ({ t }) => {
  return (
    <div className="flex flex-col items-start justify-start gap-4 max-[915px]:max-w-full max-[1080px]:max-w-[260px] max-w-[312px]">
      ...
      {/* Labels */}
      <div className="flex flex-col gap-2 max-md:px-4">
        <p className="text-xs text-text-secondary font-semibold">{t.labels}</p>
        <p className="text-xs text-text-primary ">{t.none}</p>
      </div>
      ...
      {/* Avatars */}
      <div className="flex flex-col gap-2 max-md:px-4">
        <p className="text-xs text-text-secondary font-semibold">{t.cool}</p>
        <div className="flex gap-1 items-center flex-wrap">
          ...
          <p className="font-xs text-text-primary">{t.more}</p>
        </div>
