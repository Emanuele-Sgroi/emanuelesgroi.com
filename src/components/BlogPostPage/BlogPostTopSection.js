...
const BlogPostTopSection = ({ blogPost }) => {
  ...
  return (
    <div className="relative w-full center px-6 overflow-hidden">
      <div className="w-full max-w-[1020px] pt-10 z-50">
        <Link
          href="/writings"
        ...
        {/* Title and subtitle */}
        <div className="w-full flex flex-col justify-start items-start gap-3 mt-14 mb-8">
          <h1 className="text-[48px] font-bold leading-tight poppins-extrabold">
            {postTitle}
          </h1>
